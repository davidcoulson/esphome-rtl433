...
external_components:
  - source: github://davidcoulson/esphome-rtl433@v0.1.1
    components: [rtl_433]
...
| `detector:` `squelch` | `-Y squelch` | | Skip blocks below the noise estimate: two thirds less decoding CPU on a quiet 2 MS/s band |
